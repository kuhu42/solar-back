...
//   const [selectedUserType, setSelectedUserType] = useState(''); // Added this
...
//       setCurrentUser(updatedProfile); // Update context immediately
      
//       showToast('Customer registration completed! Welcome to GreenSolar!');
//       // Don't redirect to login - let the dashboard router handle it
//     } catch (error) {
...
//     const profileData = {
//       role: professionalForm.role, // ✅ Actual role (freelancer, agent, etc.)
//       status: 'pending', // ✅ Status = pending (not role)
...
//             <img 
//               src="/solar-back/public/download.png" 
//               alt="GreenSolar Logo" 
...
//   // Customer and Professional forms remain the same...
