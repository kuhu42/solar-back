      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className="text-left bg-gray-50 rounded-lg p-4 mb-6">
          ...
          <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="flex items-center">
              ...
              <span className="capitalize">{user.requested_role || user.role}</span>
            </div>
            <div className="flex items-center">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 space-y-3">
          ...
          <button
            ...
            className="flex items-center justify-center w-full px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium"
          >
